...
public class UserStatsResponse {
    ...
    private Long baseUserCountBefore30Days;
    ...
    public static UserStatsResponse empty() {
        return UserStatsResponse.builder()
                .totalUsers(0L).activeUsers(0L).lockedUsers(0L)
                .newUsersToday(0L).newUsersThisWeek(0L)
                .newUsersThisMonth(0L).newUsersLastMonth(0L)
                .baseUserCountBefore30Days(0L)
                .dailyGrowth(List.of()).recentUsers(List.of())
                .build();
    }
}
